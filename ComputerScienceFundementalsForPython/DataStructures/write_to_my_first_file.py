...
#open the file
def write_file(file_name, a_output):
    output_file = open(file_name, "w")
    
    output_file.write(str(a_output))
    output_file.close()
...
#Note: for file to write, the file must exist in the working directory, or else an error will be returned.