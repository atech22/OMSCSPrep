...
#Add your code here!
def complete_profile(dict_input):
    first, middle, last, title = dict_input
    #print(first)

    dict_input["name"] = dict_input[first] + " " + dict_input[last]
    #print(dict_input["name"])
    dict_input["full_name"] = dict_input[title] + " " + dict_input[first] + " " + dict_input[middle] + " " + dict_input[last]
    #print(dict_input["full_name"])
    dict_input["short_name"] = dict_input[first][0] + " " + dict_input[last]
