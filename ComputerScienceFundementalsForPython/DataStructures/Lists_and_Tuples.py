...
def sort_artists(input_list_of_artists):
    artist_name_list = []
    artist_revenue_list = []
    for ordered_artists in input_list_of_artists:
        artist_name_list.append((ordered_artists[0]))
        artist_revenue_list.append((ordered_artists[1]))
        artist_name_list.sort()
        artist_revenue_list.sort(reverse=True)
    #print(artist_name_list)
    #print(artist_revenue_list)
    return ( artist_name_list, artist_revenue_list)
