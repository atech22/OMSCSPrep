...
def find_winner(games):
    ...
    for game in games:
        if game[0] == game[1]:
            pass
        elif game[0] == "Scissors" and game[1] == "Rock":
            wins["player2"] += 1
        elif game[0] == "Rock" and game[1] == "Scissors":
            wins["player1"] += 1
        elif game[0] == "Paper" and game[1] == "Scissors":
            wins["player2"] += 1
        elif game[0] == "Scissors" and game[1] == "Paper":
            wins["player1"] += 1
        elif game[0] == "Rock" and game[1] == "Paper":
            wins["player2"] += 1
        elif game[0] == "Paper" and game[1] == "Rock":
            wins["player1"] += 1
    if wins["player1"] > wins["player2"]:
        return "Player 1 wins!"
    elif wins["player1"] < wins["player2"]:
