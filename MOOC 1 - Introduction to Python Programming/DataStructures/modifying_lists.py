...
def modify_list(input_list):
    new_list = input_list
    #print("original: " + str(input_list))
    new_list.sort()
    #print("sort: " + str(new_list))
    new_list.reverse()
    #print("reverse: " + str(new_list))
    del new_list[-3:]
    #print("delete last 3: " + str(new_list))
    if 7 in new_list:
        new_list.remove(7)
    #print("remove the number 7" + str(new_list))
    new_list[0] *= 2
    new_list[2] *= 2
    #print("multiply item 1 and 3 by 2" + str(new_list))
    return new_list
